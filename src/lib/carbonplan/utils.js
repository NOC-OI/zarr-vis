...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export const getSiblings = (tile, { viewport, zoom, size, camera, order, projection }) => {
...
export const getDescendantsToRender = (targetKey, tiles, maxZoom) => {
  const [initialX, initialY, initialZ] = keyToTile(targetKey);
...
export const getChunks = (selector, dimensions, coordinates, shape, chunks, x, y) => {
